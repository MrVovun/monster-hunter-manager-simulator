...
namespace VolFx
{
    [Serializable, VolumeComponentMenu("VolFx/Scanlines (Tv)")]
    public sealed class ScanlinesVol : VolumeComponent, IPostProcessComponent
    {
        ...
        public ClampedFloatParameter m_DistortionPeriod   = new ClampedFloatParameter(0, 0, 1); 
        [InspectorName("Density")]
        public ClampedFloatParameter m_DistortionDensity  = new ClampedFloatParameter(0, 0, 1);

        // =======================================================================
        // Can be used to skip rendering if false
        public bool IsActive() => active && (m_Intensity.value > 0 || m_Flip.value > 0 || m_Flicker.value > 0 || m_DistortionPower.value > 0);
