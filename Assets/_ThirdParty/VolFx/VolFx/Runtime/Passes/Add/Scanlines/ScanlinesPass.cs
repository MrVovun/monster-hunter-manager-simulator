...
namespace VolFx
{
    ...
    public class ScanlinesPass : VolFx.Pass
    {
        ...
        public override bool Validate(Material mat)
        {
            ...
            mat.SetVector(s_Distortion, new Vector4(settings.m_DistortionPower.value, 
                                                    Time.time * Mathf.Lerp(0f, 150f, settings.m_DistortionPeriod.value),
                                                    Mathf.Lerp(0, 200f, settings.m_DistortionDensity.value)));
